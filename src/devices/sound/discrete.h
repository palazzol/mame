...
#define DISCRETE_CRFILTER_OLD(NODE,INP0,RVAL,CVAL)                      DSC_SND_ENTRY( NODE, dst_crfilter    , DSS_NODE        , 3, DSE( static_cast<int>(INP0),static_cast<int>(OPT_NODE(RVAL)),static_cast<int>(OPT_NODE(CVAL)) ), DSE( INP0,RVAL,CVAL ), nullptr, "DISCRETE_CRFILTER" ),
#define DISCRETE_CRFILTER(NODE,INP0,RVAL,CVAL)                          DISCRETE_FILTER1(NODE,1,INP0,(1.0/(2.0*3.14159*RVAL*CVAL)),DISC_FILTER_HIGHPASS)
...
#define DISCRETE_RCFILTER_OLD(NODE,INP0,RVAL,CVAL)                      DSC_SND_ENTRY( NODE, dst_rcfilter    , DSS_NODE        , 3, DSE( static_cast<int>(INP0),static_cast<int>(OPT_NODE(RVAL)),static_cast<int>(OPT_NODE(CVAL)) ), DSE( INP0,RVAL,CVAL ), nullptr, "DISCRETE_RCFILTER" ),
#define DISCRETE_RCFILTER(NODE,INP0,RVAL,CVAL)                          DISCRETE_FILTER1(NODE,1,INP0,(1.0/(2.0*3.14159*RVAL*CVAL)),DISC_FILTER_LOWPASS)
